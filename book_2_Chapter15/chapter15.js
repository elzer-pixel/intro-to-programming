...
// adding an event listener to the whattodo button
todoButton.addEventListener("click", displayActivity);

// creating a new Date object
let d = new Date();

// calling the displayDate() function
displayDate();
...
function displayActivity() {
	...
	/* set a variable, called youShould, with a 
	different string based on what day of the week it is*/
		let youShould;
	switch(dayOfWeek) {
		case 0:
      	...
      	break;
     case 1:
     		youShould = "Gotta do what you gotta do!";
     		break;
     case 2:
